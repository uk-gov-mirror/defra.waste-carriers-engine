...
module WasteCarriersEngine
  class GovpayFormsController < ::WasteCarriersEngine::FormsController
    ...
    def payment_callback
      ...
      Rails.logger.warn "Govpay payment callback error for payment uuid \"#{params[:uuid]}\""
      Airbrake.notify("Govpay callback error for payment uuid", payment_uuid: params[:uuid])
