    ...
    context "when a valid user is signed in" do
      ...
      context "when a valid transient registration exists" do
        ...
        it "returns a success response" do
          get new_contact_address_form_path(transient_registration[:reg_identifier])
      ...
      context "when a valid transient registration exists" do
        ...
        context "when valid params are submitted" do
          ...
          it "updates the transient registration" do
            ...
            expect(transient_registration.reload.contact_address.uprn.to_s).to eq(valid_params[:temp_address])
          end
    ...
    context "when a valid user is signed in" do
      ...
      context "when a valid transient registration exists" do
        ...
        context "when the skip_to_manual_address action is triggered" do
          it "returns a 302 response" do
            get skip_to_manual_address_contact_address_forms_path(transient_registration[:reg_identifier])
            expect(response).to have_http_status(302)
          end
