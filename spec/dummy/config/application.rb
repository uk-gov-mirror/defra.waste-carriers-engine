...
module Dummy
  class Application < Rails::Application
    ...
    config.govpay_front_office_api_token = ENV["WCRS_GOVPAY_FRONT_OFFICE_API_TOKEN"] || "token"
    config.govpay_back_office_api_token = ENV["WCRS_GOVPAY_BACK_OFFICE_API_TOKEN"] || "token"
