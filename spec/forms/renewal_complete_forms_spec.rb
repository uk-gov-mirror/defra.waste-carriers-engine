...
RSpec.describe RenewalCompleteForm, type: :model do
  describe "#submit" do
    context "when the form is valid" do
      let(:renewal_complete_form) { build(:renewal_complete_form, :has_required_data) }
      let(:valid_params) { { reg_identifier: renewal_complete_form.reg_identifier } }

      it "should submit" do
        expect(renewal_complete_form.submit(valid_params)).to eq(true)
      end
    end
    ...
    context "when the form is not valid" do
      ...
      it "should not submit" do
        expect(renewal_complete_form.submit(invalid_params)).to eq(false)
      end
    end
  end
