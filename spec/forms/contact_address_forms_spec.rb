  ...
  describe "#transient_registration" do
    context "when the transient registration is invalid" do
      ...
      it "inherits the errors from the transient_registration" do
        contact_address_form.valid?
        expect(contact_address_form.errors[:base]).to include(I18n.t("mongoid.errors.models.transient_registration.attributes.reg_identifier.invalid_format"))
      end
    end
  end
end
